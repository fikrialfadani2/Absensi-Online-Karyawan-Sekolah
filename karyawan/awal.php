                    ...
                    <div class="container-fluid">
                                ...
                                <table class="table table-borderless table-striped table-earning" >
                                        ...
                                        <tbody>
                                           ...
                                           <tr>
                                            ...
                                            <tr>
                                                <td><button type="submit" name="simpan" class="btn btn-primary">Hadir</button></td>
                     ...
                     <div class="row">
                                ...
                                <table class="table table-borderless table-striped table-earning" >
                                        ...
                                        <tbody>
                                            <tr>
                                               ...
                                               <a href="?m=karyawan&s=title"><button class="btn btn-warning">Tidak Hadir</button></a>
                                            </td>
                                            </tr>
                        ...
                        <div class="header-desktop">
                            <div class="col-md-12">
                                <div class="copyright">
                                    <p>Copyright © 2022 Fikri Alfadani All rights reserved. Template by <a href="https://colorlib.com">Colorlib</a>.</p>
                                </div>
                            </div>
                        </div>
                    </div>
